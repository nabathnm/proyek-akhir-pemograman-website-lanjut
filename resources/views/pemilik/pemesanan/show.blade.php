<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-wrap items-center gap-2">
            <a href="{{ route('pemilik.pemesanan.index') }}" class="nb-btn py-1 px-2 text-base">Kelola Pemesanan</a>
    ...
    <div class="pt-6">
        <div class="nb-shell max-w-3xl space-y-6">
                    ...
                    <div>
                        ...
                        <p class="nb-kicker mt-1">
                            @if($pemesanan->status === 'pending')
                                Pesanan menunggu keputusan Anda.
                ...
                <div class="mt-5 grid gap-4 lg:grid-cols-[220px_minmax(0,1fr)] lg:items-stretch">
                    ...
                    <div class="nb-card-soft p-4 md:p-5">
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            <div class="min-w-0">
                                <a href="{{ route('pemilik.kosan.show', $pemesanan->kosan) }}" class="block text-3xl font-black leading-none">
            ...
            <div class="flex gap-3">
                <a href="{{ route('pemilik.pemesanan.index') }}" class="nb-btn flex-1">Kembali</a>
                @if($pemesanan->status === 'pending')
                    ...
                    <form method="POST" action="{{ route('pemilik.pemesanan.tolak', $pemesanan) }}" class="flex-1" onsubmit="return confirm('Yakin ingin menolak pemesanan ini?')">
                        @csrf
                        @method('PATCH')
