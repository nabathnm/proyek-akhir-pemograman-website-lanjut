<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-wrap items-center gap-2">
            <a href="{{ route('pemilik.kosan.index') }}" class="nb-btn py-1 px-2 text-base">Kosan Saya</a>
                ...
                <aside class="space-y-6">
                    ...
                    <section class="nb-card p-5 md:p-6">
                        ...
                        <div class="mt-4 flex flex-col gap-3">
                            <a href="{{ route('pemilik.kosan.edit', $kosan) }}" class="nb-btn nb-btn-secondary w-full">Edit</a>
                            <form action="{{ route('pemilik.kosan.destroy', $kosan) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus kosan ini? Tindakan ini tidak dapat dibatalkan.')">
                                @csrf
                                @method('DELETE')
