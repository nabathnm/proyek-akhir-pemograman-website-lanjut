<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-bold text-xl text-gray-800">Tambah Kosan Baru</h2>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('pemilik.kosan.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_kosan" value="{{ old('nama_kosan') }}" placeholder="Contoh: Kos Bu Ani"
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="4" placeholder="Jelaskan tentang kosan Anda..."
                                      class="w-full px-4 py-2.5 rounded-lg border {{ $errors->has('deskripsi') ? 'border-red-400 bg-red-50' : 'border-gray-200' }} text-sm focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent resize-none">{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="kota" value="{{ old('kota') }}" placeholder="Yogyakarta"
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="harga_per_bulan" value="{{ old('harga_per_bulan') }}" placeholder="500000"
                        ...
                        <div>
                            ...
                            <input type="number" name="jumlah_kamar" value="{{ old('jumlah_kamar') }}" min="1" placeholder="10"
                        ...
                        <div>
                            ...
                            <input type="number" name="kamar_tersedia" value="{{ old('kamar_tersedia') }}" min="0" placeholder="5"
                ...
                {{-- Card: Upload Foto --}}
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <h3 class="font-semibold text-gray-800 text-base mb-1 pb-3 border-b border-gray-100">📷 Foto Kosan</h3>
                    <p class="text-xs text-gray-400 mt-3 mb-4">Upload minimal 1 foto. Foto pertama akan dijadikan foto utama. Format: JPG, PNG, GIF. Maks 2MB/foto.</p>

                    <label for="fotos"
                           class="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:border-green-400 hover:bg-green-50 transition-all duration-200">
                    ...
                    @error('fotos.*')<p class="text-red-500 text-xs mt-2">{{ $message }}</p>@enderror
                ...
                Array.from(input.files).forEach(function(file, i) {
                    ...
                    reader.onload = function(e) {
                        ...
                        div.innerHTML = `<img src="${e.target.result}" class="w-full h-24 object-cover rounded-lg border border-gray-100">
                            ${i === 0 ? '<span class="absolute top-1 left-1 bg-green-600 text-white text-xs px-1.5 py-0.5 rounded font-semibold">Utama</span>' : ''}`;
